...
var board = new firmata.Board("/dev/ttyACM0", function(){
    ...
    console.log("Aktiviramo Pin 12");
    board.pinMode(12, board.MODES.OUTPUT); // pin12 kot izhod
    console.log("Aktiviramo Pin 11");
    board.pinMode(11, board.MODES.OUTPUT); // pin11 kot izhod
...
board.on("ready", function() {
    ...
    board.analogRead(0, function(value){
        želenaVrednost = value; // zvezno branje analogne nožice 0
         ...
         if(želenaVrednost >= 450 && želenaVrednost <= 550)
        {
